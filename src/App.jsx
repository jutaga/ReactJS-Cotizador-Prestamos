...
function App() {
  //Los states solo se declaran para variables que se van a modifficar en un futuro
  ...
  //Si la funcion va asociada a un evento, se pone nombre handle seguido del evento por convencion de react
